      ...
      //lv.setAdapter(ad);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String[] sarray = {"Attended: " + al.get(position).attended, "Missed: " + al.get(position).missed,
                        "Canceled: " + al.get(position).canceled, "Not Responded: " + al.get(position).notRespond};
